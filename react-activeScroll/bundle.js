	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    "Click to show the pic's num" + this.props.imgNum
	                )
	            );
	        }
	    }]);
	...
	var App = (function (_Component2) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var imagesRow = [];
	            var newimgsUrl = _dataJson.imgsUrl.slice(visibleStart, visibleEnd);
	            var newimgsNum = _dataJson.imgsNum.slice(visibleStart, visibleEnd);
