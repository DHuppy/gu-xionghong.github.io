...
function applyIf(e, t) {
    if (e)
        for (var n in t) isDefined(e[n]) || (e[n] = t[n]);
    return e
}
...
function Carousel(e, t) {
    ...
    this.run = function(e, t) {
        ...
        i.css({
            position: "absolute",
            "z-index": "999"
        }), i.attr("src", t.videoUrls[n]), i.on("loadeddata", function() {
...
function PageB(e, t) {
    ...
    function o() {
        var e = new Carousel(u, {
            ...
            videoUrls: ["http://www.imooc.com/upload/media/qx-one.mp4", "http://www.imooc.com/upload/media/qx-two.mp4", "http://heongu-blog.com/wp-content/uploads/2015/12/pageC.mp4"]
        });
        return e
    }
    var s = e,
        a = s.find(".christmas-boy"),
        u = s.find("#carousel"),
        c = s.find(".girl"),
        l = s.find(".cat"),
        f = {
        ...
        d = {
            ...
            walk: function(e) {
                var t = $.Deferred();
                return c.addClass("girl-walk"), c.transition({
                    left: "4.5rem"
                }, f.girl.walk, "linear", function() {
                    t.resolve()
                }), t
            },
            stopWalk: function() {
            ...
            hugWalk: function(e) {
                c.addClass("girl-weep"), c.transition({
                    left: "7rem"
                }, f.girl.hugWalk, "linear", function() {
...
function PageC() {
    this.$deer = $(".deer"), this.$window = $(".page-c .window"), this.$leftWin = this.$window.find(".window-left"), this.$rightWin = this.$window.find(".window-right"), this.$sceneBg = this.$window.find(".window-scene-bg"), this.$closeBg = this.$window.find(".window-close-bg"), this.$sceneBg.transition({
        opacity: 0
    }, 3e3), this.$closeBg.css("transform", "translateZ(0)"), this.$closeBg.transition({
        opacity: 1
    }, 5e3);
    var e = this;
...
function(e, t) {
    ...
    function E(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n && (s += Z.css(e, n + Ce[o], !0, i)), r ? ("content" === n && (s -= Z.css(e, "padding" + Ce[o], !0, i)), "margin" !== n && (s -= Z.css(e, "border" + Ce[o] + "Width", !0, i))) : (s += Z.css(e, "padding" + Ce[o], !0, i), "padding" !== n && (s += Z.css(e, "border" + Ce[o] + "Width", !0, i)));
        return s
    }
    ...
    function S(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s], r.style && (o[s] = ve.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Te(r) && (o[s] = ve.access(r, "olddisplay", x(r.nodeName)))) : (i = Te(r), "none" === n && i || ve.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
    ...
    function H(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = Ge || D(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, s = 0, u = c.tweens.length; u > s; s++) c.tweens[s].run(o);
    ...
    var ie = function(e) {
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[W] && (i = v(i)), o && !o[W] && (o = v(o, s)), r(function(r, s, a, u) {
                var c, l, f, d = [],
                    ...
                    b = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, b, a, u), i)
                    for (c = m(b, p), i(c, [], a, u), l = c.length; l--;)(f = c[l]) && (b[p[l]] = !(y[p[l]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = p(function(e) {
                ...
                if (n = C.relative[e[a].type]) l = [p(h(l), n)];
                else {
        ...
        var x, w, C, T, k, E, N, S, A, D, j, q, O, L, H, $, P, M, F, W = "sizzle" + 1 * new Date,
            I = e.document,
            R = 0,
            B = 0,
            _ = n(),
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (l = m[W] || (m[W] = {}), c = l[e] || [], p = c[0] === R && c[1], d = c[0] === R && c[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (d = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++d && f === t) {
                                        l[e] = [R, p, d];
                                        break
                                    }
                            } else if (y && (c = (t[W] || (t[W] = {}))[e]) && c[0] === R) d = c[1];
                            else
                                for (;
                                    (f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[W] || (f[W] = {}))[e] = [R, d]), f !== t)););
        ...
        return f.prototype = C.filters = C.pseudos, C.setFilters = new f, E = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (i = he.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !C.relative[a = s.type]);)
                    if ((u = C.find[a]) && (r = u(s.matches[0].replace(we, Ce), be.test(o[0].type) && l(t.parentNode) || t))) {
    ...
    Z.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) o[i] && Z.isFunction(o[i].promise) ? o[i].promise().done(c(i, r, o)).fail(u.reject).progress(c(i, n, t)) : --a;
    ...
    Z.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(pe) || [""], c = t.length; c--;)
                    if (a = De.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Ae.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando] ? t : new Z.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0;
                    (s = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || p, l = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), l && l.apply(s, n), l = c && s[c], l && l.apply && Z.acceptData(s) && (t.result = l.apply(s, n), t.result === !1 && t.preventDefault());
    ...
    Fe.optgroup = Fe.option, Fe.tbody = Fe.tfoot = Fe.colgroup = Fe.caption = Fe.thead, Fe.th = Fe.td, Z.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, s, a, u, c, l = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++)
                if (i = e[d], i || 0 === i)
            ...
            for (l.textContent = "", d = 0; i = f[d++];)
                if ((!r || -1 === Z.inArray(i, r)) && (u = Z.contains(i.ownerDocument, i), o = v(l.appendChild(i), "script"), u && g(o), n))
                    for (c = 0; i = o[c++];) $e.test(i.type || "") && n.push(i);
            return l
        },
        ...
        domManip: function(e, t) {
            ...
            if (c && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)
                    for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++) s = i[u], $e.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Me, "")))
            }
            return this
        }
    }), Z.each({
    ...
    e.attachEvent && e.attachEvent("onunload", function() {
        ...
        return G.cors || qt && !e.crossDomain ? {
            send: function(n, r) {
                ...
                t = function(e) {
                    return function() {
                        t && (delete Dt[s], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(jt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                            text: o.responseText
...
function(e, t) {
    ...
    return f = null, e.cssEase = {
        ...
        var p = s(f, n, r, u),
            ...
            m = h ? parseInt(n, 10) + parseInt(u, 10) : 0;
        if (0 === m) {
            var v = function(e) {
...
var Observer = function(e) {
        function t(e, t) {
            var n, r = this.events = this.events || {},
                i = e.split(/\s+/),
                o = 0,
                s = i.length;
...
! function() {
    function e(e) {
        var n = document.getElementById(e),
            r = n.getContext("2d"),
            i = config.layer.width,
            o = config.layer.height;
